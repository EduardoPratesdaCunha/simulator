...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-500 text-gray-800">
      <header class="flex justify-around bg-orange-300 py-10">
        <h1>Titulo</h1>
        <div>
          <a href="{{ route('auth.index') }}" class="bg-blue-500 text-white font-bold my-6 py-2 px-4 rounded hover:bg-blue-600">Faça login</a>
          <a href="{{ route('auth.register') }}" class="bg-green-500 text-white font-bold my-6 py-2 px-4 rounded hover:bg-green-600">Registra-se</a>
        </div>
      </header>
